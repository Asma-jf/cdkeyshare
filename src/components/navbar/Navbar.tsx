...
import { AlignJustify, ChevronDown, Home, Search, Store } from "lucide-react";
    ...
    <div className="navbar">
      ...
      <div className={styled.main_navbar}>
        ...
        <div className="md:hidden">
          ...
          {isMenuVisible && (
            <ul className="z-index-1000 absolute bg-white w-48 shadow-lg p-5 pt-2 rounded-md">
        ...
        <button
          className="mr-15 md:hidden"
          onClick={() => setIsleftMenuVisible(!isleftMenuVisible)}
        >
          محصولات
          {isleftMenuVisible && (
            <div
              className={`md:hidden items-center absolute left-0 bg-white shadow rounded-lg z-index-1000 p-4 mt-3 ${styled.mainMenu}`}
            >
              <ul className="">
                <li>
      ...
      <Container>
        <div className="flex items-center justify-between">
          ...
          <form className={styled.search_form} action="">
            <div onClick={toggleVisibility} className={styled.select}>
              <span className="text-xs sm:text-sm md:text-base">دسته بندی</span>
            </div>
        ...
        <div className={`hidden md:flex items-center ${styled.mainMenu}`}>
